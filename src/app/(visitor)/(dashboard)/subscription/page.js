    ...
    <div className="bg-black06 text-white min-h-screen p-4">
      ...
      {isPayPalBtnShow ? (
        ...
        <div>
          ...
          <div className=" bg-gray-800 p-6 rounded-lg shadow-md mt-40">
           ...
           */}
            ...
            <button
              onClick={() => {
                if (subscriptionDetails?.isFreeSubscribe == "0") {
                  setIsPayPalBtnShow(true);
                } else {
                  toast("You are already subscribed");
                }
              }}
              className="mt-4 w-full bg-yellow py-2 rounded-md text-black06"
            >
              {subscriptionDetails?.isFreeSubscribe == "0"
                ? "Subscribe"
                : "Subscribed"}
            </button>
          </div>
